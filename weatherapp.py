...
def data_get():
    city = city_name.get()  # Call the get method to get the value of city_name
    data = requests.get("https://api.openweathermap.org/data/2.5/weather?q=" + city + "&appid=bba21b98e827ad0871836d3f88378223").json()
...
win.geometry("500x570")  # Fix the geometry string
